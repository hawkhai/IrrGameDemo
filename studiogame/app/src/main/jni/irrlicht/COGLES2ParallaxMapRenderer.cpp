...
// Irrlicht Engine OGLES2 render path normal map vertex shader
        const c8 VertexShaderFile[]   = "/mnt/sdcard/GameDemo/COGLES2ParallaxMap.vsh";
        const c8 FragmentShaderFile[] = "/mnt/sdcard/GameDemo/COGLES2ParallaxMap.fsh";
...
//! material renderer should be set.
        void COGLES2ParallaxMapRenderer::OnSetConstants( IMaterialRendererServices* services, s64 userData )
        {
